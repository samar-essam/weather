...
// {
//   let response= await fetch("http://api.weatherapi.com/v1/search.json?key=649d6c58fb9748938c594007211609&q=lond",{
//         method:'post' ,
...
// }
// searchInput.addEventListener("keyup",x=>{findWeather(x.target.value)});
